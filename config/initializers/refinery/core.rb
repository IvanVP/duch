...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = ENV['REFINERY_SITE_NAME']
  ...
  config.menu_css = {:selected=>"selected", :open => "open", :first=>"first", :last=>"last"}
  ...
  config.register_javascript "timepicker.addon.js"
